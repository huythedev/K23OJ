...
urlpatterns = [
    ...
    path('problems', include([
        ...
        path('/autoproblem', problem.ProblemAutoProblem.as_view(), name='problem_autoproblem'),
           path('/autoproblem/status/<uuid:task_id>', problem.autoproblem_task_status,
               name='problem_autoproblem_status'),
           path('/autoproblem/status/<uuid:task_id>/details', problem.autoproblem_task_details,
    ...
    path('problem/<str:problem>', include([
        ...
        path('/pdf/<slug:language>', problem.ProblemPdfView.as_view(), name='problem_pdf'),
           path('/samples', problem.ProblemSampleTestcases.as_view(), name='problem_sample_testcases'),
           path('/samples/<int:case_id>/<str:kind>', problem.problem_sample_testcase_download,
               name='problem_sample_testcase_download'),
